...
export default function PricingPage() {
  ...
  const serviceStructuredData = {
    ...
    "@type": "Service",
    serviceType: "Quantitative Investment Services",
    provider: {
    ...
    offers: tiers.map((tier) => ({
      ...
      price: tier.size,
      priceCurrency: "USD",
      description: `Investment tier with ${tier.managementFee} management fee, ${tier.performanceFee} performance fee, and ${tier.support} support.`,
