      ...
      <main className="min-h-screen px-6 py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto space-y-8 text-gray-700 dark:text-gray-300">
          ...
          <ul className="list-disc pl-5 space-y-3">
            ...
            <li>
              <strong>Data use.</strong> You may not scrape, reverse engineer,
              or redistribute data beyond your license.
            </li>
            <li>
            ...
            <li>
              <strong>Availability.</strong> APIs may change, be versioned, or
              be withdrawn with notice where reasonably practicable.
            </li>
          </ul>
        </div>
      </main>
