    ...
    <>
      ...
      >
        ...
        <div className="space-y-4 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            financial infrastructure more accessible, programmable and scalable.
          </p>
          <p>
            Financial markets are complex, fragmented and technically difficult
            to build on. We combine data engineering, quantitative research,
            machine learning and execution technology so institutions and
            developers can build on a common foundation.
          </p>
          <p>
            The brand is globally oriented: infrastructure that can operate
            across markets and jurisdictions as capabilities and licenses allow.
          </p>
        </div>
      </motion.section>
      ...
      <section className="grid md:grid-cols-2 gap-10 text-gray-700 dark:text-gray-300">
        ...
        >
          ...
          <p className="leading-relaxed">
            A financial ecosystem where institutions, developers and researchers
            can build sophisticated market applications on reliable
            infrastructure.
          </p>
        </motion.div>
      </section>
