      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <header>
          ...
          <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
            Evermount Capital is committed to maintaining the highest standards
            of regulatory compliance across all jurisdictions in which we
            operate. This page outlines our regulatory framework, licensing, and
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <p className="text-base leading-7 mb-4 text-gray-700 dark:text-gray-300">
              ...
              services regulations in the jurisdictions where we provide
              services. Our regulatory compliance framework includes:
            </p>
            <ul className="space-y-3 list-disc pl-5 text-base leading-7 text-gray-700 dark:text-gray-300">
              <li>
                Securities and Exchange Commission (SEC) regulations (where
                applicable)
              </li>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base leading-7 text-gray-700 dark:text-gray-300">
                  ...
                  investment management tools and analytics. Our platform
                  services are provided under appropriate technology and
              ...
              <div>
                ...
                <p className="text-base leading-7 text-gray-700 dark:text-gray-300">
                  Investment services may be provided through licensed
                  third-party entities or partnerships with regulated financial
                  institutions, depending on jurisdiction and service type.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-lg mb-2 text-gray-900 dark:text-white">
                ...
                <p className="text-base leading-7 text-gray-700 dark:text-gray-300">
                  Payment processing services are provided through licensed
                  payment service providers and financial institutions that
                  maintain appropriate regulatory authorizations.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <ul className="space-y-4 list-disc pl-5 text-base leading-7 text-gray-700 dark:text-gray-300">
              <li>
                ...
                Comprehensive anti-money laundering and counter-terrorism
                financing program with customer due diligence, transaction
              ...
              <li>
                ...
                Know Your Customer (KYC) verification for all users, including
                identity verification, address verification, and source of funds
              ...
              <li>
                ...
                GDPR, CCPA, and other data protection law compliance with
              ...
              <li>
                ...
                Segregation of client funds, appropriate custody arrangements,
              ...
              <li>
                ...
                Policies and procedures to identify, manage, and disclose
              ...
              <li>
                ...
                Policies to ensure best execution of client orders where
                applicable.
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Formal complaints handling procedures and escalation processes.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <p className="text-base leading-7 mb-4">
              We maintain appropriate regulatory reporting and disclosure
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <p className="text-base leading-7">
              We continuously monitor regulatory developments and update our
              policies, procedures, and systems to ensure ongoing compliance.
              Our compliance team works closely with legal advisors and
              regulatory consultants to stay abreast of changes in applicable
        ...
        <section className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 p-6 rounded-lg">
            <p className="text-base leading-7 mb-4">
              While we maintain appropriate safeguards, investors should be
              aware that:
            </p>
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              <li>Investments are not covered by deposit insurance schemes</li>
              <li>
                Investments are not guaranteed by any government or regulatory
                body
              </li>
        ...
        <section className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-600 p-6 rounded-lg">
          <p className="text-sm leading-6 text-gray-700 dark:text-gray-300">
            ...
            This page provides general information about our regulatory
            compliance framework. Specific regulatory requirements may vary by
            jurisdiction and service type. Investors should consult with
            qualified advisors regarding regulatory matters in their
            jurisdiction.
          </p>
        </section>
      </div>
