      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="space-y-8 text-base leading-7">
          ...
          <ol className="space-y-6 list-decimal pl-5">
            <li>
              <strong>Data Collected:</strong> Name, email, IP address, device
            ...
            <li>
              ...
              at rest using industry best practices.
            </li>
            ...
            <li>
              <strong>International Storage:</strong> Data may be stored across
              multiple secure jurisdictions.
            </li>

            <li>
              <strong>Regulatory Compliance:</strong> We comply with GDPR, CCPA,
              and Kenyan Data Protection guidelines.
            </li>

            <li>
              <strong>User Rights:</strong> You may request access, correction,
            ...
            <li>
              <strong>Email Communications:</strong> We may email you regarding
              platform changes, promotions, or reports.
            </li>
            ...
            <li>
              <strong>Automated Decision Making:</strong> Some features may use
              AI to auto-adjust strategy insights.
            </li>

            <li>
              <strong>Data Breach Policy:</strong> In case of a breach, affected
              users will be notified within 72 hours.
            </li>

            <li>
              <strong>Children:</strong> Our platform is not intended for users
              under the age of 18.
            </li>
            ...
            <li>
              <strong>Behavioral Profiling:</strong> We may use user actions to
              suggest optimized investment models.
            </li>
            ...
            <li>
              <strong>Contact Us:</strong> For any privacy concerns, email us at
              privacy@evermount.com.
            </li>
          </ol>
        </section>
      </div>
