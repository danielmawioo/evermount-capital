          ...
          <div className="space-y-8 text-base leading-7 text-gray-700 dark:text-gray-300">
            ...
            <ol className="space-y-6 list-decimal pl-5">
              ...
              <li>
                ...
                custodian, exchange or investment adviser unless expressly
                stated in a signed agreement.
              </li>
              <li>
                <strong>Intellectual property.</strong> Evermount retains rights
                in its software, models and documentation. Customers retain
                rights in their own data, subject to licenses granted to operate
                the service.
              </li>
              <li>
              ...
              <li>
                <strong>Fees.</strong> Fees, if any, are set out in an order
                form. This website does not list fund management or performance
                fees.
              </li>
              <li>
                <strong>Availability.</strong> We do not guarantee uninterrupted
                service. Maintenance, vendor outages and force majeure may
                affect access.
              </li>
              <li>
              ...
              <li>
                ...
                provided in the commercial agreement. Access may be suspended
                for abuse, security risk or legal requirement.
              </li>
            </ol>
          </div>
        </div>
