      ...
      <main className="min-h-screen px-6 py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto space-y-8 text-gray-700 dark:text-gray-300">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li>
              <strong>Data licensing.</strong> Data is licensed, not sold.
              Rights are limited to the use cases in your agreement.
            </li>
            <li>
              <strong>Redistribution.</strong> Redistribution to third parties
              is prohibited unless expressly allowed in writing.
            </li>
            <li>
            ...
            <li>
              <strong>Third-party data.</strong> Exchange, vendor and
              alternative data remain subject to those providers&apos; terms.
            </li>
            <li>
