...
export default function Navbar() {
  ...
  return (
    <>
      {/* Waitlist Banner */}
      <div className="bg-gradient-to-r from-emerald-500 via-green-500 to-lime-400 text-white text-sm sm:text-base text-center px-4 py-1.5 font-medium shadow z-50">
        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black bg-opacity-50 px-4">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md relative">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
            <button
                  ...
                  <li className="flex items-start space-x-3 hover:text-black">
                    ...
                    <Link href="/careers">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Join a team shaping the future of hedge fund
                          investing.
                        </p>
                      </div>
                    </Link>
