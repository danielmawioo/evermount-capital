    ...
    <TranslateTree>
      <main className="min-h-screen px-6 py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto space-y-8 text-gray-700 dark:text-gray-300">
          ...
          <p>
            IMPORTANT: Please read this risk disclosure carefully. Using
            financial technology involves risk. This is not an investment
            product disclosure for a fund.
          </p>
          <LegalNotice />
          <ul className="list-disc pl-5 space-y-3">
            ...
            <li>
              <strong>Market data risk.</strong> Feeds may be delayed, missing
              or wrong. Decisions based on data can be flawed.
            </li>
            <li>
