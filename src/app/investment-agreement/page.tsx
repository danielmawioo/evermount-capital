      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <ul className="space-y-3 list-disc pl-5 text-base leading-7 text-gray-700 dark:text-gray-300">
              ...
              <li>Seek independent financial, legal, and tax advice before investing</li>
              <li>Understand and accept all investment risks</li>
              <li>Provide updated information when your circumstances change</li>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <ul className="space-y-4 list-disc pl-5 text-base leading-7">
              <li>
                <strong>Management Fees:</strong> Annual management fees as disclosed 
                in your selected investment plan (typically 2% of assets under management).
              </li>
              <li>
                <strong>Performance Fees:</strong> Performance fees may apply (typically 
                20% of profits above high-water mark) as disclosed in your investment plan.
              </li>
              <li>
                <strong>Transaction Fees:</strong> Certain transactions may incur fees 
                as disclosed at the time of transaction.
              </li>
              <li>
                <strong>Withdrawal Fees:</strong> Withdrawal fees may apply depending 
                on withdrawal method and frequency.
              </li>
              <li>
                <strong>Fee Disclosure:</strong> All fees are disclosed in your investment 
                plan documentation and fee schedule. You will be notified of any fee changes.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <ul className="space-y-4 list-disc pl-5 text-base leading-7">
              <li>
                <strong>Minimum Investment:</strong> Minimum investment amounts vary by 
                investment plan and are disclosed at the time of selection.
              </li>
              <li>
                <strong>Lock-Up Periods:</strong> Some investments may have lock-up 
                periods during which withdrawals are restricted.
              </li>
              <li>
                <strong>Redemption Terms:</strong> Withdrawal requests may be subject 
                to notice periods and processing times as disclosed in your investment plan.
              </li>
              <li>
              ...
              <li>
                <strong>Performance Reporting:</strong> Performance reports are provided 
                periodically as disclosed in your investment plan.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-600 p-6 rounded-lg">
            ...
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              ...
              <li>You have sufficient financial resources to bear the risk of loss</li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              ...
              <li>
                We are not liable for third-party actions or system failures beyond 
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              ...
              <li>
                We may suspend or terminate your account for breach of this Agreement, 
                regulatory violations, or suspicious activity
              </li>
              <li>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              ...
              <li>
                Disputes will be resolved through arbitration or competent courts 
                as per applicable law
              </li>
              <li>
                You may have rights under consumer protection laws in your jurisdiction
              </li>
            </ul>
          </div>
        </section>
