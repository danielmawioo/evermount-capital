      ...
      <main className="min-h-screen px-6 py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto space-y-8 text-gray-700 dark:text-gray-300">
          ...
          <p>
            ...
            commercial interests, vendor relationships and customer interests.
            We aim to identify, manage and disclose material conflicts in
            customer agreements rather than act as a discretionary investment
            manager for website visitors.
          </p>
        </div>
      </main>
    </TranslateTree>
