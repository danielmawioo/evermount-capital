      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <header>
          ...
          <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
            Evermount Capital is committed to managing conflicts of interest
            fairly and transparently. This policy outlines how we identify,
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <p className="text-base leading-7 text-gray-700 dark:text-gray-300">
              Evermount Capital maintains policies and procedures to identify,
              prevent, manage, and disclose conflicts of interest that may arise
              between our interests and those of our clients, or between the
              interests of different clients. We are committed to acting in the
              best interests of our clients and maintaining the highest
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <ul className="space-y-3 list-disc pl-5 text-base leading-7 text-gray-700 dark:text-gray-300">
              <li>
                ...
                We may trade for our own account or related entities, which may
              ...
              <li>
                ...
                Our compensation may create incentives that conflict with client
                interests
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Receipt of goods or services from brokers or other service
                providers
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Transactions with affiliates, related entities, or connected
                parties
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Access to material non-public information that could benefit
                certain clients
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Deciding which clients receive access to limited investment
                opportunities
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Personal investments by employees that may conflict with client
                interests
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            <ul className="space-y-4 list-disc pl-5 text-base leading-7 text-gray-700 dark:text-gray-300">
              <li>
                ...
                Information barriers, separate reporting lines, and independent
                oversight functions
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Separate management of different activities, separate accounts,
              ...
              <li>
                ...
                Transparent disclosure of conflicts to affected clients where
                appropriate
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Written policies and procedures for identifying and managing
                conflicts
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                ...
                Regular training on conflict identification and management
              </li>
              <li>
                <strong className="text-gray-900 dark:text-white">
                  Monitoring:
              ...
              <li>
                ...
                Restrictions on personal trading by employees
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              <li>
                Disclose the conflict to affected clients in a clear and timely
                manner
              </li>
              <li>
                Provide sufficient information for clients to make informed
                decisions
              </li>
              <li>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 p-6 rounded-lg">
            ...
            <ul className="space-y-3 list-disc pl-5 text-base leading-7">
              ...
              <li>
                Make informed decisions about whether to proceed with
                transactions
              </li>
